...
- **Sumber Referensi**: `new_sidbm` (`resources/js/Components/AppRadioGroup.vue`)
- **File Target**: `component.vue`

## Deskripsi
Komponen referensi `AppRadioGroup` berbasis Vue 3 dan Tailwind CSS dari aplikasi `new_sidbm`.
