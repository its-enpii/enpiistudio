...
- **Sumber Referensi**: `new_sidbm` (`resources/js/Components/AppEmptyState.vue`)
- **File Target**: `component.vue`

## Deskripsi
Komponen referensi `AppEmptyState` berbasis Vue 3 dan Tailwind CSS dari aplikasi `new_sidbm`.
