            ...
            <Teleport to="body">
                ...
                >
                    <div
                        ...
                        ref="listbox"
                        role="listbox"
                        class="enpii-smart-select__menu fixed flex flex-col p-2 border border-solid [border-color:var(--overlay-border-color)] rounded-control bg-surface-container-lowest shadow-overlay overflow-hidden origin-top"
