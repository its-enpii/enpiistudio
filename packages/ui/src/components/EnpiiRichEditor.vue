...
<template>
    <div class="enpii-rich-editor overflow-hidden border border-solid border-outline-variant rounded-control bg-surface-container-lowest focus-within:border-primary-container focus-within:[box-shadow:var(--shadow-focus)]" :class="[shapeClass, { 'enpii-rich-editor--disabled border-danger-border opacity-65': disabled }]">
