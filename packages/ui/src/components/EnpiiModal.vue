        ...
        <Transition name="modal">
            ...
            >
                ...
                >
                    ...
                    <footer v-if="$slots.footer" class="enpii-modal__footer flex shrink-0 flex-wrap justify-end gap-3 py-4 px-4 sm:px-6 border-t border-solid [border-color:var(--overlay-border-color)]"><slot name="footer" /></footer>
                </section>
            </div>
        </Transition>
    </Teleport>
