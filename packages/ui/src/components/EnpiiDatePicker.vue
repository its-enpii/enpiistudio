                    ...
                    >
                        <div class="enpii-date-picker__header flex items-center justify-between gap-1 mb-3">
                            <div class="enpii-date-picker__nav-group flex items-center gap-1">
                                <button type="button" class="enpii-date-picker__nav-button grid place-items-center w-8 h-8 p-1 border-0 rounded-lg bg-transparent text-outline cursor-pointer [transition-property:all] duration-fast ease-emphasized hover:bg-surface-container-low hover:text-primary-text active:scale-90 focus-visible:outline-none focus-visible:[box-shadow:0_0_0_3px_color-mix(in_srgb,var(--color-primary-container)_30%,transparent)]" :aria-label="t('datePicker.previousYear')" @click="moveView(0, -1)"><AppIcon name="keyboard_double_arrow_left" class="enpii-date-picker__nav-icon w-5 h-5 text-xl leading-none" /></button>
                                <button type="button" class="enpii-date-picker__nav-button grid place-items-center w-8 h-8 p-1 border-0 rounded-lg bg-transparent text-outline cursor-pointer [transition-property:all] duration-fast ease-emphasized hover:bg-surface-container-low hover:text-primary-text active:scale-90 focus-visible:outline-none focus-visible:[box-shadow:0_0_0_3px_color-mix(in_srgb,var(--color-primary-container)_30%,transparent)]" :aria-label="t('datePicker.previousMonth')" @click="moveView(-1)"><AppIcon name="chevron_left" class="enpii-date-picker__nav-icon w-5 h-5 text-xl leading-none" /></button>
                            </div>
                            ...
                            <div class="enpii-date-picker__nav-group flex items-center gap-1">
                                <button type="button" class="enpii-date-picker__nav-button grid place-items-center w-8 h-8 p-1 border-0 rounded-lg bg-transparent text-outline cursor-pointer [transition-property:all] duration-fast ease-emphasized hover:bg-surface-container-low hover:text-primary-text active:scale-90 focus-visible:outline-none focus-visible:[box-shadow:0_0_0_3px_color-mix(in_srgb,var(--color-primary-container)_30%,transparent)]" :aria-label="t('datePicker.nextMonth')" @click="moveView(1)"><AppIcon name="chevron_right" class="enpii-date-picker__nav-icon w-5 h-5 text-xl leading-none" /></button>
                                <button type="button" class="enpii-date-picker__nav-button grid place-items-center w-8 h-8 p-1 border-0 rounded-lg bg-transparent text-outline cursor-pointer [transition-property:all] duration-fast ease-emphasized hover:bg-surface-container-low hover:text-primary-text active:scale-90 focus-visible:outline-none focus-visible:[box-shadow:0_0_0_3px_color-mix(in_srgb,var(--color-primary-container)_30%,transparent)]" :aria-label="t('datePicker.nextYear')" @click="moveView(0, 1)"><AppIcon name="keyboard_double_arrow_right" class="enpii-date-picker__nav-icon w-5 h-5 text-xl leading-none" /></button>
                            </div>
                        </div>
