...
<template>
    ...
    >
        ...
        <div
            ...
            role="tooltip"
            :class="[
                'enpii-tooltip__bubble absolute z-30 w-56 py-1 px-2 border border-solid [border-width:var(--overlay-border-width)] border-outline-variant rounded-lg bg-on-surface text-surface-inverse text-xs leading-[1.45] shadow-lg pointer-events-none transition-[opacity,transform,visibility] duration-fast ease-decelerate',
