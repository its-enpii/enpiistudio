...
<template>
    ...
    <Transition name="splash-fade">
        <div
            v-if="showSplash"
            class="enpii-desktop-splash-screen__splash fixed inset-0 z-[9999] flex h-screen w-screen flex-col items-center justify-center [background-color:var(--desktop-splash-bg)] [color:var(--desktop-splash-fg)] select-none"
            style="-webkit-app-region: drag;"
        >
            <!-- Background Ambient Glow -->
            <div class="enpii-desktop-splash-screen__glow absolute -left-24 -top-24 h-96 w-96 rounded-full [background-color:var(--desktop-splash-fg)] opacity-15 [filter:blur(64px)]"></div>
            <div class="enpii-desktop-splash-screen__glow absolute -bottom-24 -right-24 h-96 w-96 rounded-full [background-color:var(--desktop-splash-fg)] opacity-15 [filter:blur(64px)]"></div>
            ...
            <div class="enpii-desktop-splash-screen__content relative flex flex-col items-center px-6 text-center" style="-webkit-app-region: no-drag;">
                ...
                <!-- Welcome Text -->
                <h1 class="enpii-desktop-splash-screen__title m-0 [color:var(--desktop-splash-fg)] text-2xl font-semibold tracking-tight sm:text-3xl">
                    {{ t('splash.welcome') }}
                </h1>
                <p class="enpii-desktop-splash-screen__subtitle mt-1 [color:var(--desktop-splash-fg)] opacity-85 text-sm font-semibold tracking-wide">
                    Enpii Studio Desktop
                </p>
                <p class="enpii-desktop-splash-screen__tenant mt-1 mb-0 max-w-80 truncate [color:var(--desktop-splash-fg)] opacity-70 text-xs">
                    {{ tenantName }}
                </p>

                <!-- Loading Bar & Status -->
                <div class="enpii-desktop-splash-screen__progress-wrap mt-8 w-64">
                    <div class="enpii-desktop-splash-screen__progress-track h-2 w-full overflow-hidden rounded-full [background-color:var(--progress-track)]">
                        <div
                            class="enpii-desktop-splash-screen__progress-bar h-full rounded-full [background-color:var(--progress-fill)] transition-all duration-300 ease-emphasized"
                            :style="{ width: `${splashProgress}%` }"
                        ></div>
                    </div>
                    <div class="enpii-desktop-splash-screen__progress-meta mt-2 flex justify-between [color:var(--desktop-splash-fg)] opacity-70 text-[.6875rem]">
                        <span>{{ splashStatus }}</span>
                        <span class="enpii-desktop-splash-screen__percent font-mono [color:var(--desktop-splash-fg)]">{{ splashProgress }}%</span>
                    </div>
                </div>
            </div>

            <!-- Footer copyright / version -->
            <div class="enpii-desktop-splash-screen__footer absolute bottom-6 [color:var(--desktop-splash-fg)] opacity-70 text-[.6875rem]">
                {{ t('splash.footer') }}
            </div>
        </div>
    </Transition>
    ...
    <Transition name="exit-fade">
        <div
            v-if="showExit"
            class="enpii-desktop-splash-screen__exit fixed inset-0 z-[9999] flex h-screen w-screen cursor-wait flex-col items-center justify-center [background-color:var(--desktop-splash-bg)] [color:var(--desktop-splash-fg)] select-none [backdrop-filter:blur(24px)]"
            style="-webkit-app-region: drag;"
        >
            <div class="enpii-desktop-splash-screen__content relative flex flex-col items-center px-6 text-center" style="-webkit-app-region: no-drag;">
                ...
                <h2 class="enpii-desktop-splash-screen__title m-0 [color:var(--desktop-splash-fg)] text-xl font-semibold tracking-tight">
                    {{ t('splash.goodbye') }}
                </h2>
                <p class="enpii-desktop-splash-screen__tenant mt-1 mb-0 max-w-80 truncate [color:var(--desktop-splash-fg)] opacity-70 text-xs">
                    {{ exitStatus }}
                ...
                <div class="enpii-desktop-splash-screen__closing mt-6 flex items-center gap-2 [color:var(--desktop-splash-fg)] opacity-70 text-[.6875rem] font-medium">
                    <span class="enpii-desktop-splash-screen__pulse inline-block h-2 w-2 rounded-full [background-color:var(--desktop-splash-fg)] motion-safe:animate-[splash-ping_1s_cubic-bezier(0,0,.2,1)_infinite]"></span>
