    ...
    <Teleport to="body">
      <Transition name="enpii-popover">
        <div
          ...
          class="enpii-popover__panel fixed flex overflow-auto min-w-44 max-w-[min(22rem,calc(100vw_-_1rem))] rounded-control border border-solid [border-width:var(--overlay-border-width)] [border-color:var(--overlay-border-color)] [background-color:var(--overlay-surface-bg)] [color:var(--overlay-surface-fg)] shadow-overlay [transform-origin:center]"
          :class="[
