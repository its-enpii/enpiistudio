...
<template>
    <div
        v-bind="$attrs"
        class="enpii-segmented-control relative box-border w-full p-1 border border-solid border-outline-variant rounded-control bg-surface-container-lowest isolate max-w-full"
        :class="[
