...
export function renderMarkdownHtml(raw) {
    ...
    return blocks.map((block) => {
        ...
        t = t.replace(/\[([^\]]+)\]\((https?:\/\/[^\s)]+|\/[^\s)]+)\)/g, '<a href="$2" target="_blank" rel="noopener noreferrer" class="enpii-md-link">$1<span class="material-symbols-outlined enpii-md-link__icon">open_in_new</span></a>');
