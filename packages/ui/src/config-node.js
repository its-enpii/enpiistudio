...
const configFiles = ['enpii.ui.config.js', 'enpii.ui.config.mjs', 'enpii.ui.config.ts']

export async function loadEnpiiUiConfig(cwd = process.cwd()) {
  for (const filename of configFiles) {
    ...
    return defineEnpiiUiConfig(value)
  }
